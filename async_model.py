...
def command_req():
    ...
    recognizer.pause_threshold = 1  # Set pause threshold for recognizing speech
    recognizer.non_speaking_duration = 0.8  # Set non-speaking duration for recognizing speech
    recognizer.operation_timeout = 10  # Set operation timeout for speech recognition
    recognizer.phrase_threshold = 1  # Set phrase threshold for recognizing speech
...
def wait_for_command():
    ...
    recognizer.non_speaking_duration = 1  # Set non-speaking duration for recognizing speech
    recognizer.operation_timeout = 10  # Set operation timeout for speech recognition
...
def generate_prompt(command):
    playsound.playsound('Jarvis_voice_commands/command_responses/Generating travel plan based on your command..mp3')
...
def create_plan(text_prompt):
    ...
    playsound.playsound('Jarvis_voice_commands/command_responses/Your travel plan has been created successfully.mp3')
    return plan_text
...
def opener(command):
    if 'youtube' in command or 'ютуб' in command:
        ...
        playsound.playsound('Jarvis_voice_commands/command_responses/Opening YouTube..mp3')
        playsound.playsound('Jarvis_voice_commands/command_responses/What do you want to watch on YouTube.mp3')
        ...
        playsound.playsound('Jarvis_voice_commands/command_responses/Opening Google..mp3')
        playsound.playsound('Jarvis_voice_commands/command_responses/What do you want to search.mp3')
        ...
        playsound.playsound('Jarvis_voice_commands/command_responses/Opening Telegram..mp3')
        os.system("start https://web.telegram.org")

    elif 'github' in command or 'гітхаб' in command:
        #speak("Opening GitHub.")
        playsound.playsound('Jarvis_voice_commands/command_responses/Opening GitHub..mp3')
        os.system("start https://github.com")
    elif 'instagram' in command or 'інстаграм' in command:
        #speak("Opening Instagram.")
        playsound.playsound('Jarvis_voice_commands/command_responses/Opening Instagram..mp3')
        os.system("start https://www.instagram.com")
    elif 'discord' in command or 'діскорд' in command:
        #speak("Opening Discord.")
        playsound.playsound('Jarvis_voice_commands/command_responses/Opening Discord..mp3')
        os.system("start https://discord.com/app")
    else:
        playsound.playsound('Jarvis_voice_commands/command_responses/Maybe you want something else Please specify..mp3')
        #speak("Maybe you want something else? Please specify.")


def filehandle():
    #peak("What file do you want to create? PDF, TXT, or DOCX?")
    playsound.playsound("Jarvis_voice_commands/command_responses/What file do you want to create. PDF, TXT, or DOCX.mp3")
    type = input("Enter file type (pdf/docx/txt): ").strip().lower()
    #speak("Please enter the name of the file you want to create.")
    playsound.playsound("Jarvis_voice_commands/command_responses/Please enter the name of the file you want to create..mp3")
    ...
    if not filename.endswith(('.pdf', '.docx', '.txt')):
        ...
        playsound.playsound("Jarvis_voice_commands/command_responses/Invalid file type. Please try again..mp3")
    ...
    try:
        with open(filename, 'w') as file:
            ...
            playsound.playsound("Jarvis_voice_commands/command_responses/Do you want to write something in this file..mp3")
            command = command_req().strip().lower()
            if 'yes' in command or 'так' in command:
                os.system(f"start {filename}")
                #speak("You can write in the file now.")
                playsound.playsound("Jarvis_voice_commands/command_responses/You can write in the file now..mp3")
            else:
                #speak("File created without any content.")
                playsound.playsound("Jarvis_voice_commands/command_responses/File created without any content..mp3")
...
def aps(command):
    ...
    if 'calculator' in command or 'калькулятор' in command:
        ...
        playsound.playsound('Jarvis_voice_commands/command_responses/Opening Calculator..mp3')
        os.system("start calc")
    elif 'notepad' in command or 'блокнот' in command:
        #speak("Opening Notepad.")
        playsound.playsound('Jarvis_voice_commands/command_responses/Opening Notepad..mp3')
        os.system("start notepad")
    elif 'docs' in command or 'документи' in command:
        #speak("Opening Documents.")
        playsound.playsound('Jarvis_voice_commands/command_responses/Opening Documents..mp3')
        webbrowser.open("https://docs.google.com/document/u/0/")
    else:
        #speak("I don't know this application. Please try again.")
        playsound.playsound("Jarvis_voice_commands/command_responses/I don't know this application. Please try again..mp3")


def runner(command):
    #speak("Please specify the application you want to run.")
    playsound.playsound("Jarvis_voice_commands/command_responses/Please specify the application you want to run..mp3")
    ...
    if 'gothic' in app_name or 'gothic 3' in app_name or 'gothic' in command or 'gothic 3' in command:
        ...
        playsound.playsound("Jarvis_voice_commands/command_responses/Opening Gothic 3..mp3")
        ...
        playsound.playsound("Jarvis_voice_commands/command_responses/Gothic 3 is now running..mp3")
        playsound.playsound("Jarvis_voice_commands/command_responses/Do you want to lower the volume to 20%.mp3")
        ...
        if 'yes' in response or 'так' in response:
            ...
            playsound.playsound("Jarvis_voice_commands/command_responses/Volume set to 20%..mp3")
            playsound.playsound("Jarvis_voice_commands/command_responses/Enjoy your game.mp3")
        ...
        playsound.playsound("Jarvis_voice_commands/command_responses/Opening Counter-Strike 2..mp3")
        subprocess.Popen(r'start steam://run/730', shell=True)
        #speak("Do you want to lower the volume to 70%?")
        playsound.playsound("Jarvis_voice_commands/command_responses/Do you want to lower the volume to 70%.mp3")
        response = command_req().strip().lower()
        if 'yes' in response or 'так' in response:
            devices = AudioUtilities.GetSpeakers()
            interface = devices.Activate(
            ...
            #speak("Enjoy your game!")
            playsound.playsound("Jarvis_voice_commands/command_responses/Volume set to 70%..mp3")
            playsound.playsound("Jarvis_voice_commands/command_responses/Enjoy your game.mp3")

    elif 'titan' in app_name or 'titan' in command or 'quest' in app_name or 'quest' in command:
        #speak("Opening Titan Quest.")
        playsound.playsound("Jarvis_voice_commands/command_responses/Opening Titan Quest..mp3")
        ...
        playsound.playsound("Jarvis_voice_commands/command_responses/Opening Terraria..mp3")
...
def add_music():
    ...
    playsound.playsound("Jarvis_voice_commands/command_responses/Please enter the name of the song you want to add..mp3")
    song_name = input("Enter song name: ").strip().lower() 
    #speak("Please enter the YouTube link for the song.")
    playsound.playsound("Jarvis_voice_commands/command_responses/Please enter the YouTube link for the song..mp3")
    ...
    if song_name and song_link:
        ...
        playsound.playsound("Jarvis_voice_commands/command_responses/Invalid input. Please try again..mp3")
...
def set_timer(amount):
    ...
    try:
        ...
        playsound.playsound("Jarvis_voice_commands/command_responses/Beep!!, Beep!!, Timer is out STAND UP!.mp3")  # частота 1000Гц, тривалість 1 сек
    except:
        print("🔔 Дзвінок!")
...
async def handle_weather(command):
    ...
    playsound.playsound("Jarvis_voice_commands/command_responses/Can i get your location to get the weather Sir.mp3")
    ...
    if 'yes' in confirm or 'sure' in confirm:
        ...
        playsound.playsound("Jarvis_voice_commands/command_responses/Ok than enter the city where you want to get weather.mp3")
...
def set_alarm(target_time: datetime.time):
    while True:
        ...
        if now.hour == target_time.hour and now.minute == target_time.minute:
            ...
            playsound.playsound("'ALARM, ALARM, the clock is out. You must to go to do something'")
...
def open_film(command):
    ...
    if match:
        ...
        playsound.playsound("Jarvis_voice_commands/command_responses/Enjoy your watching.mp3")
    else:
        #speak('Something went wrong try again')
        playsound.playsound("Jarvis_voice_commands/command_responses/Something went wrong try again.mp3")
            ...
            while True:
                ...
                if 'who i am' in command or 'who am i' in command or 'what is my name' in command:
                    ...
                    if match:
                        ...
                        playsound.playsound("Jarvis_voice_commands/command_responses/I didn't catch your name. Please try again..mp3")
                ...
                if 'close browser' in command or 'закрити браузер' in command or 'close the browser' in command or 'close google' in command:
                    ...
                    playsound.playsound("Jarvis_voice_commands/command_responses/Closing all browser windows..mp3")
                ...
                if 'wikipedia' in command or 'вікіпедія' in command:
                    ...
                    playsound.playsound("Jarvis_voice_commands/command_responses/What do you want to search on Wikipedia.mp3")
